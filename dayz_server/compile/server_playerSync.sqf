...
if (_characterID != "0") then {
	...
	if (_characterID != "0") then {		
		...
		*/
		...
		_wealth = 	      ["wealth",_character] call server_getDiff2;
		_bank = 	      ["bank",_character] call server_getDiff2;
