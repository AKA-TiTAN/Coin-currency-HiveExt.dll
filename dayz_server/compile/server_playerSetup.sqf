private ["_characterID","_playerObj","_playerID","_dummy","_worldspace","_state","_doLoop","_key","_primary","_medical","_stats","_humanity","_lastinstance","_wealth","_bank","_friendlies","_randomSpot","_position","_debug","_distance","_hit","_fractures","_score","_findSpot","_pos","_isIsland","_w","_clientID","_spawnMC","_namespace"];
...
_playerObj setVariable["bank_CHK",_bank];
_playerObj setVariable["wealth",_wealth,true];
_playerObj setVariable["wealth_CHK",_wealth];
